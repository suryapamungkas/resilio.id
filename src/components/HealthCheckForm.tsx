    ...
    <section id="health-check" className="py-16 sm:py-24 bg-resilio-black border-b border-resilio-black-border relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-resilio-forest-950 text-resilio-forest-300 border border-resilio-forest-800 text-xs font-bold uppercase tracking-wider">
            <ShieldAlert className="w-3.5 h-3.5 text-resilio-blood-400" />
