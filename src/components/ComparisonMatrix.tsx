  ...
  return (
    <section id="comparison" className="py-16 sm:py-24 bg-resilio-black border-b border-resilio-forest-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <SectionHeader
          badgeIcon={Shield}
          badgeText="Matriks Komparasi Transparan"
          title="Mengapa Ekosistem Resilio Berbeda?"
          description="Bandingkan solusi ketahanan terpadu Resilio dengan jebakan pinjaman predator dan keterbatasan tabungan pasif konvensional."
        />
